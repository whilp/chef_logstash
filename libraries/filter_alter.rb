...
class Chef
  class Resource
    class LogstashFilterAlter < Chef::Resource::LogstashConfig


      def condrewriteother(arg=nil)
        set_or_return(:condrewriteother, arg, :kind_of => [Array])
      end
      ...
      def coalesce(arg=nil)
        set_or_return(:coalesce, arg, :kind_of => [Array])
      end

      def condrewrite(arg=nil)
        set_or_return(:condrewrite, arg, :kind_of => [Array])
      end
