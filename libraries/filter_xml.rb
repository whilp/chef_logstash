...
class Chef
  class Resource
    class LogstashFilterXml < Chef::Resource::LogstashConfig
      ...
      def store_xml(arg=nil)
        set_or_return(:store_xml, arg, :kind_of => [TrueClass, FalseClass])
      end
      ...
      def xpath(arg=nil)
        set_or_return(:xpath, arg, :kind_of => [Hash])
      end
