...
class Chef
  class Resource
    class LogstashInputFile < Chef::Resource::LogstashConfig
      ...
      def stat_interval(arg=nil)
        set_or_return(:stat_interval, arg, :kind_of => [Fixnum])
      end
      ...
      def start_position(arg=nil)
        set_or_return(:start_position, arg, :kind_of => [String], :equal_to => %w(beginning end) )
      end
