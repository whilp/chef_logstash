...
class Chef
  class Resource
    class LogstashInputGemfire < Chef::Resource::LogstashConfig
      ...
      def interest_regexp(arg=nil)
        set_or_return(:interest_regexp, arg, :kind_of => [String])
      end

      def query(arg=nil)
        set_or_return(:query, arg, :kind_of => [String])
      end
      ...
      def serialization(arg=nil)
        set_or_return(:serialization, arg, :kind_of => [String])
      end
