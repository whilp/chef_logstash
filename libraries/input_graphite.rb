...
class Chef
  class Resource
    class LogstashInputGraphite < Chef::Resource::LogstashConfig
      ...
      def ssl_enable(arg=nil)
        set_or_return(:ssl_enable, arg, :kind_of => [TrueClass, FalseClass])
      end

      def ssl_verify(arg=nil)
        set_or_return(:ssl_verify, arg, :kind_of => [TrueClass, FalseClass])
      end
      ...
      def data_timeout(arg=nil)
        set_or_return(:data_timeout, arg, :kind_of => [Fixnum])
      end
      ...
      def ssl_key_passphrase(arg=nil)
        set_or_return(:ssl_key_passphrase, arg, :kind_of => [String])
      end

      def ssl_cacert(arg=nil)
        set_or_return(:ssl_cacert, arg, :kind_of => [String])
      end

      def ssl_cert(arg=nil)
        set_or_return(:ssl_cert, arg, :kind_of => [String])
      end

      def ssl_key(arg=nil)
        set_or_return(:ssl_key, arg, :kind_of => [String])
      end
