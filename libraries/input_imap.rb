...
class Chef
  class Resource
    class LogstashInputImap < Chef::Resource::LogstashConfig
      ...
      def lowercase_headers(arg=nil)
        set_or_return(:lowercase_headers, arg, :kind_of => [TrueClass, FalseClass])
      end
      ...
      def check_interval(arg=nil)
        set_or_return(:check_interval, arg, :kind_of => [Fixnum])
      end

      def fetch_count(arg=nil)
        set_or_return(:fetch_count, arg, :kind_of => [Fixnum])
      end
