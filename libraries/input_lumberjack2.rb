...
class Chef
  class Resource
    class LogstashInputLumberjack2 < Chef::Resource::LogstashConfig
      ...
      def their_public_key(arg=nil)
        set_or_return(:their_public_key, arg, :kind_of => [String])
      end

      def my_secret_key(arg=nil)
        set_or_return(:my_secret_key, arg, :kind_of => [String])
      end
