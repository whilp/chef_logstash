...
class Chef
  class Resource
    class LogstashInputRabbitmq < Chef::Resource::LogstashConfig
      ...
      def arguments(arg=nil)
        set_or_return(:arguments, arg, :kind_of => [Array])
      end
      ...
      def auto_delete(arg=nil)
        set_or_return(:auto_delete, arg, :kind_of => [TrueClass, FalseClass])
      end

      def passive(arg=nil)
        set_or_return(:passive, arg, :kind_of => [TrueClass, FalseClass])
      end
      ...
      def ack(arg=nil)
        set_or_return(:ack, arg, :kind_of => [TrueClass, FalseClass])
      end

      def exclusive(arg=nil)
        set_or_return(:exclusive, arg, :kind_of => [TrueClass, FalseClass])
      end
      ...
      def threads(arg=nil)
        set_or_return(:threads, arg, :kind_of => [Fixnum])
      end

      def prefetch_count(arg=nil)
        set_or_return(:prefetch_count, arg, :kind_of => [Fixnum])
      end
