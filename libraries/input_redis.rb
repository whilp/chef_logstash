...
class Chef
  class Resource
    class LogstashInputRedis < Chef::Resource::LogstashConfig
      ...
      def batch_count(arg=nil)
        set_or_return(:batch_count, arg, :kind_of => [Fixnum])
      end
      ...
      def data_type(arg=nil)
        set_or_return(:data_type, arg, :kind_of => [String], :equal_to => %w(list channel pattern_channel) )
      end
